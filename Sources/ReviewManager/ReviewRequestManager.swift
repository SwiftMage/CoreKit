...
public enum ReviewManager {
    ...
    public static func incrementSignificantEventCount() {
        ...
        #else
        DebugTools.DebugLogger.review("Cannot increment event count: UIKit not available.")
        #endif
    }
    ...
    public static func requestReviewIfNeeded() {
        ...
        DebugTools.DebugLogger.review("Entering requestReviewIfNeeded()", level: .trace)
        ...
        // 4. Request review
        DebugTools.DebugLogger.review("All conditions met. Preparing to call SKStoreReviewController.requestReview(in:).", level: .info)
        ...
        #else
        DebugTools.DebugLogger.review("Review requests not available on this platform (UIKit not available).")
        #endif
    }
    ...
    public static func resetReviewRequestData() {
        ...
        #else
         DebugTools.DebugLogger.review("Cannot reset review data: UIKit not available.")
        #endif
    }
}
...
/*
 ...
 // If you don't call configure, default values (5 events, 7 days) are used.
